...
nyc_yellow_taxi_by_vendor_date_stg1 = taxi_silver.select( \
    col("vendor_id"), \
    col("tpep_pickup_datetime").cast("date").alias("trip_date") \
...
nyc_yellow_taxi_by_vendor_date_final.write.mode("append").saveAsTable("ifood_db_ws.gold.taxi_trips_by_vendor_date")